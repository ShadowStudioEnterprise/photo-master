...
$asociados[] = new Asociado("First Partner", "log1.jpg","First Partner");
$asociados[] = new Asociado("Second Partner", "log2.jpg","Second Partner");
$asociados[] = new Asociado("Third Partner", "log3.jpg","Third Partner");
